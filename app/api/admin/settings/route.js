...
export async function PUT(request) {
  ...
  const { data, error } = await supabaseAdmin.from("settings").update({
    ...
    festival_theme_enabled: body.festival_theme_enabled,
    festival_theme_name: body.festival_theme_name,
    festival_theme_end_at: body.festival_theme_end_at,
    festival_banner_text: body.festival_banner_text,
